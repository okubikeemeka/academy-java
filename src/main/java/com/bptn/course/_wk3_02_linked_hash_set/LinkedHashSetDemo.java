package com.bptn.course._wk3_02_linked_hash_set;
...
public class LinkedHashSetDemo {
	...
	public static void main(String[] args) {
		...
		// Preserves ordering of elements despite being a set. No duplicates though
		...
		// Check effect after removal method use above
